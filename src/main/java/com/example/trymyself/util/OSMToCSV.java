...
public class OSMToCSV {
    ...
    public void toCSVData(String inputOsmXmlFilePath, String outputDataCsvFilePath) {
        try {
            ...
            setUpNodes(osmNodeNodes, outputDataCsvFilePath);
            setUpEdges(osmNodeNodes, osmWayNodes, outputDataCsvFilePath);
    ...
    private void setUpNodes(List<Node> osmNodeNodes, String outputDataCsvFilePath) {
        try {
            CSVWriter writer = new CSVWriter(new FileWriter(outputDataCsvFilePath));
    ...
    //
    private void setUpEdges(List<Node> osmNodeNodes, List<Node> osmWayNodes, String outputDataCsvFilePath) {
        ...
        try {
            CSVReader csvReader = new CSVReaderBuilder(new FileReader(outputDataCsvFilePath)).build();
